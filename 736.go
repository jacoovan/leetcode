...
736:Lisp 语法解析
leetcodeID : 736
leetcode地址 : https://leetcode-cn.com/problems/parse-lisp-expression/
难度 : 困难
...
<ul>
	...
	add语法表示为 (add e1 e2)，其中 add 语法总是以字符串 "add"来表示，该语法总是有两个表达式e1<font color="#333333" face="helvetica neue, helvetica, arial, sans-serif"><span style="background-color:#ffffff; font-size:14px">、</span></font>e2, 该语法的最终结果是 e1 表达式的值与 e2 表达式的值之和。
